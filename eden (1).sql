...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2022 at 09:21 AM
...
(1, 'ณวสัน วิศิษสิงขร', 'อุบลราชธานี', '1950-11-29', 'email@e', '0239402394230', 'hakata', '4e1ca1d1339420c3034eeaa9358161d8', 2040, 'admin', '2022-12-21'),
...
(7, 'สุบรรณ เฉลิมวงศ์', 'อุบลราชธานี อำเภอ วารินชำราบ', '1980-12-31', 'subun@gmail.com', '0675453456', 'subun', 'fd73ee1fd18ebb7240afe440bb0a4c59', 160, 'admin', '2022-12-21'),
...
(14, 'ควรมีการจัดกิจกรรมต่าง ๆ ภายในชุมชนเพิ่มขึ้นไหม', '2022-12-21', 5, 12);
...
(15, 'สถานที่ในความทรงจำของทุกคนมีที่ไหนบ้าง ?', '2022-12-21', 5, 4),
(16, 'สถานณการณ์ในตอนนี้ผู้สูงอายุอย่างเราควรออกไปข้างนอกไหม ?', '2022-12-21', 5, 6),
(17, 'มีผู้สูงอายุคนไหนอยู่ตัวคนเดียวบ้างในตอนนี้', '2022-12-21', 5, 0),
(18, 'เวลาว่าง ๆ ทุกคนชอบทำอะไรกัน', '2022-12-21', 5, 11),
(19, 'มีที่ไหนบ้างใน จังหวัด อุบลฯ ที่เงียบ ๆ', '2022-12-21', 5, 17);
...
--
ALTER TABLE `member`
  MODIFY `mem_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `news`
--
ALTER TABLE `news`
  MODIFY `new_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `news_detail`
--
ALTER TABLE `news_detail`
  MODIFY `new_detail_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `news_like`
--
ALTER TABLE `news_like`
  MODIFY `new_like_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `poll`
--
ALTER TABLE `poll`
  MODIFY `poll_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `pollpost`
--
ALTER TABLE `pollpost`
  MODIFY `pp_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `poll_detail`
--
ALTER TABLE `poll_detail`
  MODIFY `poll_detail_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `webboard`
--
ALTER TABLE `webboard`
  MODIFY `web_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `webboard_detail`
--
ALTER TABLE `webboard_detail`
  MODIFY `web_detail_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
